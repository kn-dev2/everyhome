...
<div class="row">
		<div class="columns">
			...
			<img class="loading" src="{{ asset('frontend/img/loading-buffering.gif') }}" alt="">
				<script src="https://everyhomecleaningservice.launch27.com/jsbundle"></script><iframe id="booking-widget-iframe" src="https://everyhomecleaningservice.launch27.com/?w_cleaning" style="border:none;width:100%;min-height:2739px;overflow:hidden" scrolling="no"></iframe>
			</div>
		</div>
	</div>
