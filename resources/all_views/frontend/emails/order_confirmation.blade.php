		...
		<tbody>
			<tr style="vertical-align: top" valign="top">
				<td style="word-break: break-word; vertical-align: top" valign="top">
					...
					<div style="background-color: #628be3">
                    ...
                    ">
                        ...
                        ">
											...
											<div align="center" class="img-container center fixedwidth" style="padding-right: 0px; padding-left: 0px">
												<img align="center" alt="Every Home" border="0" class="center fixedwidth" src="{{asset('frontend/img/logo.png')}}" style="
                          ...
                          ">
                            ...
                            ">
                                ...
                                margin: 0;
                              ">
														<span style="font-size: 30px">Thank you for booking with us!</span>
													</p>
												</div>
											</div>
						...
						">
													...
													<h3>Phone : {{$order->customer->phone}}</h3>
                        ...
                        ">
                          ...
                          ">
                            ...
                            ">
                              ...
                              ">
														Transaction ID:
														<span style="color: #628be3"><strong>{{$order->booking_id}}</strong></span>
													</p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
                          ...
                          ">
                            ...
                            ">
								...
								text-align:center
                              ">
														Total Amount : <span style="color: #628be3;font-size:16px;font-weight:bold">${{$order->total_price}}</span>
													</p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
                        ...
                        ">
                          ...
                          ">
                            ...
                            ">
                                ...
                                margin: 0;
                              ">
														You can find more details of this order. Please click on below button.
													</p>
												</div>
											</div>
											<!--[if mso]></td></tr></table><![endif]-->
                          ...
                          ">
						  @if($user_type == 'admin')
												<a href="{{route('bookings.index')}}" style="
                              ...
                              width: auto;
                              width: auto;
                              border-top: 1px solid #628be3;
                              border-right: 1px solid #628be3;
                              border-bottom: 1px solid #628be3;
                              border-left: 1px solid #628be3;
                              padding-top: 5px;
                              padding-bottom: 5px;
                              font-family: Nunito, Arial, Helvetica Neue,
                                Helvetica, sans-serif;
