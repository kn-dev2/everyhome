    ...
    <div class="card-body">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade active show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                <br>
                <label class="col-sm-1 col-form-label">Name : </label> {{$maid->name}} <br />
                <label class="col-sm-1 col-form-label">Email : </label> {{$maid->email}} <br />
                <label class="col-sm-1 col-form-label">Status : </label> {{$maid->status==0 ? 'In-Active' : 'Active'}} <br />
